...
BuildRequires: python3-devel, python3-setuptools, python3-ihm >= 2.11
Requires:      python3-ihm >= 2.11
BuildArch:     noarch
%if 0%{?fedora} >= 42
...
%changelog
* Mon Aug 17 2026 Ben Webb <benmwebb@gmail.com>   1.8-1
- Update to latest upstream.

* Fri Apr 10 2026 Ben Webb <benmwebb@gmail.com>   1.7-1
- Update to latest upstream.

* Fri Dec 12 2025 Ben Webb <benmwebb@gmail.com>   1.6-1
- Update to latest upstream.
